...
public class FuncionarioService {
    ...
    public List<Funcionario> listarFuncionariosAniversariantes() {
        List<Object[]> resultados = repository.buscarFuncionariosAniversariantes();
        List<Funcionario> lista = new ArrayList<>();
    ...
    public List<Funcionario> listarFuncionariosAniversariantesAdmissao() {
        List<Object[]> resultados = repository.buscarFuncionariosAniversariantesAdmissao();
        List<Funcionario> lista = new ArrayList<>();
